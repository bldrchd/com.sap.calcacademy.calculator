...
public class CalculatorTest {
	...
	public void testOverallOperations_Extended() {
		String[] args1 = { "3+5-(12+1)" }, args2 = { "2*7+15-9-(1-3)" }, args3 = { "1/3+1/2" }, args4 = { "1/2-1/4*2" }, args5 = {"0.25*-1.5"};
		Calculator calculator = new Calculator();
		...
		assertEquals(-0.375, calculator.getResult(args5));
	}
	
	@Test
	public void testOverallOperations_doubleValues() {
		String[] args1 = { "0.3+0.7" }, args5 = {"0.25*-1.5"};
		Calculator calculator = new Calculator();
		assertEquals(1.0, calculator.getResult(args1));
		//assertEquals(22.0, calculator.getResult(args2));
		//assertEquals(0.8333333333333333, calculator.getResult(args3));
		//assertEquals(0.0, calculator.getResult(args4));
		assertEquals(-0.375, calculator.getResult(args5));
